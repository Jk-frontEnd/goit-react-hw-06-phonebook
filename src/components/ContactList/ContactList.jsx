...
import { getContacts, getFilter } from '../../redux/select'; // Assuming correct path and file name
import { ContactElem } from '../../components/ContactElem/ContactElem'; // Corrected import statement
